  ...
  return (
    ...
    >
      <div className="flex h-16 items-center justify-between border-b border-border px-4">
        ...
        {collapsed && (
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-text-inverse font-bold text-sm mx-auto">
            R
          </div>
        )}
      </div>
      ...
      <nav className="flex flex-col h-[calc(100vh-4rem)] overflow-y-auto py-4 px-3">
        ...
        <div className="mt-4 border-t border-border pt-4">
          <button
            ...
            className="flex w-full items-center justify-center rounded-lg p-2 text-text-tertiary hover:bg-background hover:text-text-primary"
          >
            {collapsed ? (
